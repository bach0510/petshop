...
export class CustomerService {
  ...
  getCustomerByTel(val: GetCusInputDto): Observable<any[]> {
    return this.http.post<any>(this.APIUrl + '/cus-tel', val);
  }
  getCustomerById(val: GetCusInputDto): Observable<any[]> {
    return this.http.post<any>(this.APIUrl + '/cus-by-id', val);
  }
