...
export class CreateOrEditEmployeeComponent implements OnInit {
  ...
  //   convertImageToByteType() {
  //     var canvas = document.createElement("canvas");
  //     canvas.height = this.imgContainer?.nativeElement.getBoundingClientRect().height! * 3.2;
  //     canvas.width = this.imgContainer?.nativeElement.getBoundingClientRect().width! * 3.2;
  ...
  //     this.employee.ImageString = base64Image.replace(/data:image\/jpeg;base64,/g, '');
  //     return this.employee.ImageString;
  // }

  // convertImageFromByteType() {
  //     var empImg = this.employee.ImageString ? this.employee.ImageString : '';
  //     let objectUrl = 'data:image/jpeg;base64,' + empImg;
  //     this.url = this._sanitizer.bypassSecurityTrustResourceUrl(objectUrl);
  // }

  // add() {
  //     this.selectedEmp = new EmployeeDto();
  //     this.selectedEmp.empImg = '';
  //     this.url = '';
  //     if (this.organizationUnit.id) {
  //         this.selectedEmp.organizationUnitId = this.organizationUnit?.id;
  //     }
  // }
